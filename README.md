...
5. 2024/4:
    ...
    3. Next/React,Railsを使用したSPAのポートフォリオの再作成を開始(4/27~)
6. 2024/5~6:
    1. 基本機能の実装修了(~6/11)
    2. アカウント作成/ログイン/ログアウト/ゲストログイン/退会
    3. プロフィール編集機能
       1. 名前,ワーク,パスワード,メールアドレス,プロフィール文章
　　　　  4. 日記機能(CRUD処理)
　　　　  5. フォローフォロワー機能
　　　　  6. 各種ページネイション機能
       1. フォロー一覧,フォロワー一覧,日記一覧,ユーザー一覧
7. 応用機能の実装完了(~6/26)
    1. 一意なルームへの入室・退出機能
　　　　  2. リアルタイムな座席着席機能
　　　　  3. リアルタイムなルームチャット機能
　　　　  4. プロジェクトごとのストップウォッチを使った作業時間の記録機能
　　　　  5. 作業時間の追加、削除、編集機能
　　　　  6. ダッシュボード機能
　　　　  7. 棒グラフでの日毎の作業時間の表示機能
　　　　  8. 折れ線グラフでの日毎の平均時給の表示機能
　　　　  9. 棒グラフでの日毎の稼いだ金額の表示機能
　　　　  10. 今月の平均時給の表示機能
　　　　  11. 今月の給与合計の表示機能
　　　　  12. ランダム応援ひとこと機能
　　　　  13. プロジェクト別時給平均ランキング機能
　　　　  14. ワークの種類別の時給平均ランキング機能
　　　　  15. カレンダー機能
　　　　  16. 各プロジェクトのテーブル形式での追加・編集・削除機能
